...
function dibujaTodo() {
  ...
  // El filtro afecta también al mapa: al elegir un tipo se ven sólo
  // esos marcadores. "Todos" es el único que los muestra en conjunto.
  const enElMapa = estado.filtro
    ? activos.filter(t => t.tipo === estado.filtro)
    : activos;
  mapa.pintaTrabajos(enElMapa);
  // Los contadores de la barra siguen mostrando el total real, para
  // que filtrar no esconda cuántos trabajos hay en la división.
