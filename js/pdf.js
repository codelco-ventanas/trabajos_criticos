...
export async function pdfDeclaracion(t) {
  ...
  doc.setFillColor(...(RGB[t.tipo] || RGB.cobre));
  doc.rect(14, y, ancho - 28, 11, 'F');
  doc.setTextColor(255, 255, 255);
  doc.setFont(FUENTE, 'bold');
  doc.setFontSize(11.5);
  doc.text((tipo?.nombre || t.tipo).toUpperCase(), 18, y + 7.4);
  y += 18;
  ...
  doc.autoTable({
    ...
    body: [
      ...
      ['Permiso de trabajo', 'Adjuntado al momento de la declaración'],
