...
export const TIPOS = {
  ...
  confinado: {
    ...
    permiso: 'trabajo en espacio confinado',
...
// ------------------------------------------------------------
// ------------------------------------------------------------
//  Cuántas horas permanece un trabajo en la sección
//  "Trabajos críticos finalizados" del panel lateral.
//  Se cuenta desde su hora de término, o desde el cierre si un
//  administrador lo finalizó antes de tiempo.
// ------------------------------------------------------------
export const HORAS_FINALIZADOS = 12;
