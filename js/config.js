...
// ------------------------------------------------------------
export const TIPOS = {
  caliente:  { nombre: 'Trabajo en caliente',   corto: 'Caliente',  color: '#FF4F3B', glifo: '🔥' },
  altura:    { nombre: 'Trabajo en altura',     corto: 'Altura',    color: '#FFB020', glifo: '🧗' },
  confinado: { nombre: 'Espacio confinado',     corto: 'Confinado', color: '#31B6F2', glifo: '🫧' }
};
